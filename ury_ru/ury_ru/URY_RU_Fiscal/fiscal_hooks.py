...
from ury_ru.ury_ru.URY_RU_Fiscal.fiscal_driver import get_fiscal_driver
from ury_ru.ury_ru.URY_RU_Fiscal import receipt as receipt_builder
...
def _enqueue_receipt(invoice, receipt_type):
	...
	try:
		frappe.enqueue(
			"ury_ru.ury_ru.URY_RU_Fiscal.fiscal_hooks.process_receipt",
			queue="long",
			timeout=120,
